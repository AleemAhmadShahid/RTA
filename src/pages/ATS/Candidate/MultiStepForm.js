...
const MultiStepForm = ({
  ...
  const handleSave = async (nextStep = null) => {
    ...
    saveHandler(nextStep, ["name", "email"] ,"/api/candidate", `/api/candidate/${formData._id}/`, "Candidate updated Successfully!", "candidate", errors, copyFormData, setErrors, handleChange, setReload, reload, closeForm);
