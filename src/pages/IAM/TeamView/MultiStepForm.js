...
const MultiStepForm = ({
  ...
  const handleSave = async (nextStep = null) => {
    ...
    saveHandler(nextStep, ["users"] ,`/api/department/${formData.id}/addUser`, null, "Member Added Successfully!", null, errors, copyFormData, setErrors, handleChange, setReload, reload, closeForm);
